...
import com.school.interfaces.service.impl.RedisServiceImpl;
...
/**
 * 在操作缓存的时候，采用旁路缓存模式，并且贝格缓存的时间不能太长
 * 把Object转换为Json对象存储
 */
@Configuration
public class RedisConfig {
    ...
    public RedisSerializer<Object> serializer(){
        ...
        //设置所有的get，set都可以序列号，并且所有的修饰权限也能够被序列化
        objectMapper.setVisibility(PropertyAccessor.ALL, JsonAutoDetect.Visibility.ANY);
        //必须设置，否则无法将JSON转化为对象，会转化成Map类型,
        // 同时指定序列化输入的类型，类必须是非final修饰的，final修饰的类，比如String,Integer等会跑出异常
